...
Feature: Faucet
  ...
  Scenario: Check Out of funds Faucet page
    ...
    Then Element with "xpath" "//p[contains(string(),'The faucet is out of funds currently. If you want to')]" should be "visible"
    Then Element with "xpath" "//p[contains(string(),'test your app, consider testing it locally with access to')]" should be "visible"
    Then Element with "xpath" "//p[contains(string(),'rich wallets following the instructions from our docs.')]" should be "visible"
    Then Element with "xpath" "//p[contains(string(),'rich wallets following the instructions from our docs.')]" should be "visible"
